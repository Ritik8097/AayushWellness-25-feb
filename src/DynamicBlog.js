      ...
      <main className="bg-white pt-[130px]">
        ...
        <section className="bg-white py-12">
          <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
            <Link
              to="/blogs"
              className="inline-flex items-center bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white px-8 py-4 rounded-2xl transition-all duration-200 font-medium text-lg shadow-lg hover:shadow-xl transform hover:scale-105"
            >
