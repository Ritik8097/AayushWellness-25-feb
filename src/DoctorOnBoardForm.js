...
const DoctorOnboardForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch("https://healthcare-backend-production-dc4c.up.railway.app/api/doctors/add", {
        method: "POST",
        body: formData,
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      const response = await fetch("https://healthcare-backend-production-dc4c.up.railway.app/api/doctors/download", {
