...
function MissionVision() {
  ...
  const DESKTOP_VIDEO_URL =
    "https://res.cloudinary.com/dyelrauyn/video/upload/v1746705348/ur6urwkotb4kl7r4twfq.m3u8"
  const MOBILE_VIDEO_URL =
    "https://res.cloudinary.com/dyelrauyn/video/upload/v1746705344/eb4kqbvu48fawrrfixap.m3u8"
    ...
    <div>
      ...
      <div className="relative h-[100vh] md:h-[100vh] overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col items-start justify-end md:justify-center  text-left px-6 md:px-[5vw] z-20 pb-[15vh] md:pb-0">
          ...
          >
            <span className="font-rogbold hidden md:inline" style={{ fontSize: "5.8vw", fontFamily: "ROGBold"  }}>
              Purpose, Progress, Promise
            </span>
            <span className="font-rogbold md:hidden block" style={{ fontFamily: "ROGBold"  }}>Purpose Progress Promise</span>
          </h1>
          ...
          >
            <span className="font-minion hidden md:inline" style={{ fontSize: "1.25vw", maxWidth: "38.4vw", fontFamily: "Minionpro" }}>
