...
//   <div className="footer__block1"><img src="https://berelax.com/_next/static/media/4-1.515f831f.webp" className="footer__block1-img" width="100%" height="100%" />
...
//             <div className="footer__subtitle">Explore <svg viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
//                 <path d="M2.344 5.643 8 11.3l5.657-5.657-.943-.943L8 9.415 3.286 4.7l-.942.943Z" fill="#13233B" />
//               </svg></div>
//             <div className="footer__list-sublist"><a className="footer__link" href="/contact-us">Contact Us</a><a className="footer__link" href="/faq">FAQ</a><a className="footer__link" href="/careers">Career</a><a className="footer__link" href="https://berelax.com/press-room/">Press Room</a><a className="footer__link" href="https://berelax.com/news/">Wellness Journal</a></div>
//           </div>
//           <div className="footer__list-col">
//             <div className="footer__subtitle">Treatments <svg viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
//                 <path d="M2.344 5.643 8 11.3l5.657-5.657-.943-.943L8 9.415 3.286 4.7l-.942.943Z" fill="#13233B" />
//               </svg></div>
//             <div className="footer__list-sublist"><a className="footer__link" href="/treatments/massages">Massages</a><a className="footer__link" href="/treatments/nail-care">Nail care</a><a className="footer__link" href="/treatments/beauty">Beauty</a><a className="footer__link" href="/treatments/wellness">Wellness</a><a className="footer__link" href="/treatments/combo">Combo</a></div>
//           </div>
//           <div className="footer__list-col">
//             <div className="footer__subtitle">Products <svg viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
//                 <path d="M2.344 5.643 8 11.3l5.657-5.657-.943-.943L8 9.415 3.286 4.7l-.942.943Z" fill="#13233B" />
//               </svg></div>
//             <div className="footer__list-sublist"><a className="footer__link" href="/products/travel-pillows">Pillows</a><a className="footer__link" href="/products/travel-accessories/">Travel Accessories</a><a className="footer__link" href="/products/massage-devices/">Massage devices</a><a className="footer__link" href="/products/beauty-devices/">Beauty devices</a><a className="footer__link" href="/products/register">Register Product</a><a className="footer__link" href="/products/find-retailer">Find a Retailer</a></div>
//           </div>
//         </div>
//       </div>
//     </div>
...
//         <div className="footer__socials"><a href="https://www.facebook.com/berelaxspa" className="footer__socials-item" target="_blank" rel="noreferrer"><img src="https://berelax.com/wp-content/uploads/2023/02/facebook.svg" width="100%" height="100%" alt="be relax" className /></a><a href="https://www.linkedin.com/company/be-relax/" className="footer__socials-item" target="_blank" rel="noreferrer"><img src="https://berelax.com/wp-content/uploads/2023/02/linkedin.svg" width="100%" height="100%" alt="be relax" className /></a><a href="https://instagram.com/berelax_spa" className="footer__socials-item" target="_blank" rel="noreferrer"><img src="https://berelax.com/wp-content/uploads/2023/02/instagram.svg" width="100%" height="100%" alt="be relax" className /></a></div>
...
//         <div className="footer__text">© Be Relax. All Rights Reserved 2025</div>
...
//         <div className="footer__text">Created by<a href="https://equal.design/" target="_blank" rel="noreferrer"><svg width={72} height={21} fill="none" xmlns="http://www.w3.org/2000/svg">
...
<footer className="footer snipcss-DVqsh">
      <div className="footer__block1">
        ...
        <div className="in-view fadein animated style-MzNLt" id="style-MzNLt">
          <div className="footer__block1-bottom">
            <div className="footer__socials">
              <a href="https://www.facebook.com/berelaxspa" className="footer__socials-item" target="_blank" rel="noreferrer"><img src="https://berelax.com/wp-content/uploads/2023/02/facebook.svg" width="100%" height="100%" alt="be relax" className /></a>
              <a href="https://www.linkedin.com/company/be-relax/" className="footer__socials-item" target="_blank" rel="noreferrer"><img src="https://berelax.com/wp-content/uploads/2023/02/linkedin.svg" width="100%" height="100%" alt="be relax" className /></a>
              <a href="https://instagram.com/berelax_spa" className="footer__socials-item" target="_blank" rel="noreferrer"><img src="https://berelax.com/wp-content/uploads/2023/02/instagram.svg" width="100%" height="100%" alt="be relax" className /></a>
            </div>
            <div className="footer__block1-right">
              <div className="footer__links"><a className="footer__link" href="/terms-conditions">Terms &amp; Conditions</a><a className="footer__link" href="/privacy-policy/">Privacy Policy</a></div>
              <div className="footer__select">
