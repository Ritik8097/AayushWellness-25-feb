    ...
    <div className="Container_container__NvvWg">
      <div className="Title_head__rrr2_ style-b193m" id="style-b193m">
        <h2 className="TitleAnimation_container__smkeR TitleAnimation_isSmall__wq35M">
         <div className=' text-white md:text-6xl text-[25px] leading-[1.2] '>
                   <BlurText
                     text="EXPLORE AAYUSH WELLNESS"
                     animateOn="view"
                     revealDirection="center"
                     className=' text-white md:text-6xl text-[25px] leading-[1.2] font-bold'
                   />
                   </div>
        </h2>
